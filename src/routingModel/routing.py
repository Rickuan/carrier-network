...
def create_data_model(FILE_ORDER:str, FILE_TRAVELMATRIX:str):
    ...
    def getPickupDeliveryNodes() -> list:        
        ...
        pickup_delivery_nodes.append(nu.getNodeWithNodeID("N99"))
...
def print_solution(data, manager, routing, solution):
    ...
    warehouse = nu.getNodeWithNodeID("N99")
...
def solve_PnD_problem(file_order, file_travelMatrix):
    """Entry point of the program."""
    # Instantiate the data problem.
    data = create_data_model(file_order, file_travelMatrix)
